...
<body id="bg">
	<div class="page-wraper">
		...
		<!-- header END ==== -->
		<!-- Content -->
		<div class="page-content bg-white" dir="rtl">
			<!-- inner page banner -->
			<div class="page-banner ovbl-dark" style="background-image:url(../assets/images/banner/banner3.jpg);">
				<div class="container">
					<div class="page-banner-entry">
						<h1 class="text-white">الدورات التدريبية</h1>
					</div>
				</div> 
				<!-- Breadcrumb row -->
			...
			<div class="content-block">
				...
				<div class="section-area section-sp1">
					<div class="container">
						<div class="row">
							<div class="col-lg-3 col-md-4 col-sm-12 m-b30" style="text-align: right;">
								<div class="widget courses-search-bx placeani">
									<div class="form-group">
										<div class="input-group">
											<label>بحث عن دورة</label>
											<input name="dzName" type="text" required class="form-control">
										</div>
									</div>
								</div>
								<div class="widget widget_archive">
									<h5 class="widget-title style-1">جميع الدورات</h5>
									<ul>
										<li class="active"><a href="#">الكل</a></li>
										<li><a href="#">برمجة</a></li>
										<li><a href="#">تصميم</a></li>
										<li><a href="#">لغات</a></li>
										<li><a href="#">هندسة</a></li>
									</ul>
								</div>
								<div class="widget">
								...
								<div class="row">
									...
									<div class="col-lg-12 m-b20">
										<div class="pagination-bx rounded-sm gray clearfix">
											<ul class="pagination">
												<li class="previous"><a href="#"><i class="ti-arrow-right"></i> Prev</a>
												</li>
												<li class="active"><a href="#">1</a></li>
												<li><a href="#">2</a></li>
												<li><a href="#">3</a></li>
												<li class="next"><a href="#">Next <i class="ti-arrow-left"></i></a>
												</li>
											</ul>
										</div>
									</div>
